...
export const CadastroCliente = () => {
    ...
    const handlePhoneChange = (e) => {
        ...
        if (valor.length > 10) {
            ...
            valor = valor.replace(/^(\d{2})(\d{0,5})$/, '($1) $2'); // Formato parcial (XX) XXXX
        }
        setPhoneInput(valor);
    }

    // DADOS PRO BACKEND RECEBER APOS O SUBMIT DO CADASTRO DE CLIENTE
                    ...
                    <div className='overflow-y-auto py-2'>
                        <form className='mt-4 flex flex-col justify-center gap-3 md:w-[361px]' onSubmit={handleSubmit}>
                            <div className='flex flex-col'>
                                ...
                                <input type="text" // Alterado para "text"
                                autoComplete='email'
                                value={emailInput}
